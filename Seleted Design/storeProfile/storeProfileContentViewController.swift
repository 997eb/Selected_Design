//
//  storeProfileContentViewController.swift
//  Seleted Design
//
...
class storeProfileContentViewController: UIViewController , UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    var images = [UIImage(named: "punlic2.png"), UIImage(named: "followesCell.png"),UIImage(named: "punlic2.png"),UIImage(named: "followesCell.png"),UIImage(named: "punlic2.png"),UIImage(named: "followesCell.png"),UIImage(named: "punlic2.png"),UIImage(named: "followesCell.png")]
            ...
            func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
                ...
                let myCell = collectionView.dequeueReusableCell(withReuseIdentifier:storeProfileCell.reuseIdentifier, for: indexPath) as! storeProfileCell
  ...
  init(title: String, content: String) {
    ...
    layout.sectionInset = UIEdgeInsets(top:20, left: -5, bottom: 50, right: 45)
    layout.minimumLineSpacing = 1
    layout.minimumInteritemSpacing = 1
    layout.itemSize = CGSize(width: 180, height: 210)
           myCollectionView = UICollectionView(frame: self.view.frame, collectionViewLayout: layout)
    myCollectionView?.register(storeProfileCell.self, forCellWithReuseIdentifier: storeProfileCell.reuseIdentifier)
